    ...
    return (
        <section>
            ...
            <div className="content">
                ...
                <p>
                    Dr. Jayakumar is one of the reputed Pulmonologist, Sleep Medicine Specialist, Allergist/Immunologist, Intensivist and Infectious disease specialist with a thriving experience of more than 10 years. He is specialized in diagnosing and treating Lung conditions like Asthma, Chronic Cough, COPD, smoking related Lung diseases, Bronchiectasis, Sinusitis, Tuberculosis, Recurrent Pneumonia, Chronic Fever of Unknown Origin, Sleep Apnoea and Sleep related Lung disorders, Pleural Effusion, Acute/Chronic Respiratory Failure, Interstitial Lung disease, Lung Cancer, Eosinophilic Lung disease, Acute respiratory distress syndrome, Cor pulmonale. The doctor has exemplary experience in treating Acute Breathlessness, Chest pain, Hemoptysis, Pneumothorax, Pulmonary Thromboembolism, Acute Severe Asthma, Inhalational Injury and Respiratory Failure. He has the best treatment in Pulmonary hypertension, Sarcoidosis, Vasculitis related Disorders, Occupational Lung Diseases, Pulmonary Disorders in Pregnancy, Neuromuscular Pulmonary Disorder. His supportive care of treatment includes Smoking cessation, Pulmonary rehabilitation, Oxygen therapy, Noninvasive ventilation and Invasive Ventilation, Inhalers and nebulizers, Immunosuppressive drugs, Adult Vaccination, End of Life Care for End Stage Lung Diseases. Dr. Jayakumar maintains a patient centered approach and believes in delivering quality care. He pays close attention to each patient issues in order to comprehend their worries and personalize treatment to their choices. He has done highest number of practical procedures. He hails from Neyveli having completed his DTCD in Madras Medical College and DNB from Apollo Main Hospital Chennai and Fellow in Infectious Diseases. Presented various papers in national and international journals. He worked as a consultant in Apollo KH Hospitals (Ranipet) and now at Dr Adhi Polyclinic (Virudhachalam).
                </p>
            </div>
            ...
            <div className="content">
                ...
                <div className="aoe-container">
                    ...
                    <ul className="aoe-items col-lg-6 col-md-6 col-sm-12">
                        <li><span className="icon"></span>&emsp;Asthma</li>
                        <li><span className="icon"></span>&emsp;Bronchiectasis</li>
                        <li><span className="icon"></span>&emsp;COPD</li>
                        <li><span className="icon"></span>&emsp;Acute Respiratory Distress Syndrome</li>
                        <li><span className="icon"></span>&emsp;Eosinophilic Lung Disease</li>
                        <li><span className="icon"></span>&emsp;Cor Pulmonale</li>
                        <li><span className="icon"></span>&emsp;Asbestos and Lung</li>
                        <li><span className="icon"></span>&emsp;Hypersensitivity Pneumonitis</li>
                    </ul>
                    <ul className="aoe-items col-lg-6 col-md-6 col-sm-12">
                        <li><span className="icon"></span>&emsp;Pleural Effusion</li>
                        <li><span className="icon"></span>&emsp;Pneumothorax</li>
                        <li><span className="icon"></span>&emsp;Pulmonary Hypertension</li>
                        <li><span className="icon"></span>&emsp;Pulmonary Thromboembolic disease</li>
                        <li><span className="icon"></span>&emsp;Respiratory Infection (Bacterial,Fungal,Viral)</li>
                        <li><span className="icon"></span>&emsp;Sarcoidosis</li>
